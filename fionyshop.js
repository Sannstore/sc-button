...
async function loading() {
    ...
    const interval = setInterval(async () => {
        if (i === frames.length) {
            ...
            await JamvanHax0r.sendMessage(from, { text: `FIONY-SHOP`, edit: message.key });
        } else {
                ...
                nativeFlowMessage: proto.Message.InteractiveMessage.NativeFlowMessage.create({
                    buttons: [
                                               ...
                                               
                        {
                            "name": "cta_url",
                            "buttonParamsJson": `{
                                "display_text": "HUBUNGI CS SPARKLING-SHOP",
...
await JamvanHax0r.relayMessage(m.sender, msg.message, {
...
global.JHax0rCEK = cek("APInick", jhax0rr);
global.PayDisiniKey = cek("pdsini", jhax0rr);
global.TokoPay_merchant = cek("merchant_id", jhax0rr);
global.TokoPay_secret = cek("secret_key", jhax0rr);
global.UsernameDF = cek("digiuser", jhax0rr);
global.APIkeyDF = cek("digiapi", jhax0rr);
global.api_IdSmm = cek("api_idsmm", jhax0rr);
global.api_KeySmm = cek("api_keysmm", jhax0rr);

function getSmmAuto() {
    let profit = cek("profitsmm", jhax0rr);
    let axios = require("axios");
    let fs = require("fs");
    let apiKeyA = global.JHax0rCEK
...
const sections = [
    ...
    await JamvanHax0r.relayMessage(msg.key.remoteJid, msg.message, {
        messageId: msg.key.id
    }, { quoted: m });
};
...
let { MessageType, Mimetype } = require('@whiskeysockets/baileys');
 ...
 async function sendSyaratJHax0rr() {
   const setujuJHax0r = [
    ...
    const buttonParamsJsont = `{
        ...
        "sections": [
            {
                "title": "Pilihan Menu",
                "rows": ${JSON.stringify(setujuJHax0r)}
            }
        ]
    }`;
 let msg = generateWAMessageFromContent(m.chat, {
        viewOnceMessage: {
            message: {
                ...
                interactiveMessage: proto.Message.InteractiveMessage.create({
                    body: proto.Message.InteractiveMessage.Body.create({
                        text: `Halo, Kak! Kamu belum menyetujui Syarat & Ketentuan dari Fiony Shop. Mohon setujui terlebih dahulu, agar dapat mengakses fitur dari Fiony Shop.`
                    }),
                    footer: proto.Message.InteractiveMessage.Footer.create({
                        text: ''
                    }),
    ...
    await JamvanHax0r.relayMessage(m.chat, msg.message, {
        messageId: msg.key.id
    }, { quoted: m });
    };
    async function Upgradejhax0rZz() {
 ...
 let msg = generateWAMessageFromContent(m.chat, {
        viewOnceMessage: {
            message: {
                ...
                interactiveMessage: proto.Message.InteractiveMessage.create({
                    body: proto.Message.InteractiveMessage.Body.create({
                        text: `Tentukan waktu wilayah kamu terlebih dahulu, Kak!`
                    }),
                    footer: proto.Message.InteractiveMessage.Footer.create({
                        text: ''
                    }),
 ...
 let msg = generateWAMessageFromContent(m.chat, {
        viewOnceMessage: {
            message: {
                ...
                interactiveMessage: proto.Message.InteractiveMessage.create({
                    body: proto.Message.InteractiveMessage.Body.create({
                        text: `Upss, invoice ${cek("deposit", m.sender)} masih tersedia`
                    }),
                    footer: proto.Message.InteractiveMessage.Footer.create({
                        text: ''
                    }),
 ...
 let msg = generateWAMessageFromContent(m.chat, {
        viewOnceMessage: {
            message: {
                ...
                interactiveMessage: proto.Message.InteractiveMessage.create({
                    body: proto.Message.InteractiveMessage.Body.create({
                        text: `Upss, invoice masih tersedia`
                    }),
                    footer: proto.Message.InteractiveMessage.Footer.create({
                        text: ''
                    }),
 ...
 let msg = generateWAMessageFromContent(m.chat, {
        viewOnceMessage: {
            message: {
                ...
                interactiveMessage: proto.Message.InteractiveMessage.create({
                    body: proto.Message.InteractiveMessage.Body.create({
                        text: `Upss, invoice ${cek("reff", m.sender)} masih tersedia`
                    }),
                    footer: proto.Message.InteractiveMessage.Footer.create({
                        text: ''
                    }),
 ...
 let msg = generateWAMessageFromContent(m.chat, {
        viewOnceMessage: {
            message: {
                ...
                interactiveMessage: proto.Message.InteractiveMessage.create({
                    body: proto.Message.InteractiveMessage.Body.create({
                        text: `Silahkan lakukan Verifikasi Email terlebih dahulu : ${cek("email", m.sender)}`
                    }),
                    footer: proto.Message.InteractiveMessage.Footer.create({
                        text: ''
                    }),
 ...
 let msg = generateWAMessageFromContent(m.chat, {
        viewOnceMessage: {
            message: {
                ...
                interactiveMessage: proto.Message.InteractiveMessage.create({
                    body: proto.Message.InteractiveMessage.Body.create({
                        text: `Upss, kamu tidak dapat melakukan transaksi produk ${cek("product_name", m.sender)}, karena saldo kamu tidak cukup, silahkan lakukan deposit terlebih dahulu.`
                    }),
                    footer: proto.Message.InteractiveMessage.Footer.create({
                        text: ''
                    }),
...
`
    ...
    from: `${global.emailNotif}`,
    to: `${cek("email", m.sender)}`,
    subject: `Upss, invoice ${cek("reff", sender)} udah enggak berlaku lagi`,
    html: `
<!DOCTYPE html>
<html lang="en">
<head>
...
`
    ...
    from: `${global.emailNotif}`,
    to: `${cek("email", m.sender)}`,
    subject: `Yeyy! invoice ${cek("reff", sender)} udh Fiony buatin, jangan lupa dibayar ya biar cepat diproses`,
    html: `
<!DOCTYPE html>
<html lang="en">
<head>
...
let koderefe = `FSPAY${bulany}${tanggaly}${tahuny}${kode_random}26`;
...
randomSymbol1 += '26'; // Menambahkan angka 26 ke string acak
  ...
  return 'FS' + day + month + year + randomSymbol + randomSymbol1;
}
...
> *Email:* sparklingofc22@gmail.com
> *Telegram:* t.me/sparklingofc22
...
/* End IP V4 */
case 'manfaat': {
    if (cek("verfiyemail", m.sender) == true) return reply(`Silahkan lakukan pendaftaran terlebih dahulu dengan cara mengirim command beserta email Kakak sebagai berikut.\n\n*Example:* .setemail xxxxx@gmail.com`);
    if (cek("cekVerify", m.sender) == true) return sendVerif()
    if(cek("syarat", m.sender) == true) return sendSyaratJHax0rr()
...
let axios = require('axios');
 ...
 if (cek("cekVerify", m.sender) == true) return sendVerif()
    if(cek("syarat", m.sender) == true) return sendSyaratJHax0rr()
if(cek("verfiyemail", m.sender) == true) return reply(`Silahkan lakukan pendaftaran terlebih dahulu dengan cara mengirim command beserta email Kakak sebagai berikut.\n\n*Example:* .setemail xxxxx@gmail.com`)
if(cek("level", m.sender) == "Collector Z") return reply("Upss, Kamu sudah melakukan pembayaran sebelumnya.");
    const nomor = sender.split("@")[0];
    const metodePembayaran = args[0]; // Metode pembayaran yang dipilih oleh pengguna
       if(fs.existsSync(`./SETTING/DB/TRANSACTION/Api/Deposit/${cek("deposit", m.sender)}.json`)) return JHax0rGalauV() 
    const ref_id = "ZUP26" + randomPay
    const jumlah = 25000 * 1
    let metode;
    if (!metodePembayaran) {
        return Upgradejhax0rZz()
    } else {
  ...
  async function makePayment() {
    ...
    // Membuat data form untuk permintaan pembayara
      ...
      let paymentDataResponse = paymentResponse.data.data;
        ...
        reply(`Upss, ${paymentResponse.data.msg}`)
      ...
      let signature3 = md5(create3);
        ...
        if (dataStatus === "Success") {
          const deppo = JSON.parse(fs.readFileSync(`./SETTING/DB/TRANSACTION/Api/Deposit/${cek("deposit", m.sender)}.json`))
             ...
             JamvanHax0r.sendMessage(nomor+"@s.whatsapp.net", { text : "Yeyy, Pembayaran berhasil dilakukan. Level awal *Jagoan Z* telah ditingkatkan ke *Colector Z*. Terimakasih :)"})
             setTimeout(() => {
...
JamvanHax0r.relayMessage(`${owner}@s.whatsapp.net`, msg.message, {
    messageId: msg.key.id
    }, {quoted: m});
...
case 'delprem': {
   ...
   if(cek("level", siapa + "@s.whatsapp.net") == "Jagoan Z") return reply(`Upss, User tersebut bukan merupakan User premium.`)
...
case 'addprem': {
    ...
    // Cek apakah nomor tersebut sudah menjadi anggota premium
   if(cek("level", siapa + "@s.whatsapp.net") == "Collector Z") return reply(`Upss, User tersebut merupakan User premium - Collector Z`)
...
break;
case 'transfer': {
if(cek("level", m.sender) == "Jagoan Z") return reply(`Upss, Fitur ini khusus untuk akun Collector Z (Premium)! Silahkan upgrade akun anda ke Owner.`)
 if (cek("cekVerify", m.sender) == true) return sendVerif()
    if(cek("syarat", m.sender) == true) return sendSyaratJHax0rr()
if(cek("verfiyemail", m.sender) == true) return reply(`Silahkan lakukan pendaftaran terlebih dahulu dengan cara mengirim command beserta email Kakak sebagai berikut.\n\n*Example:* .setemail xxxxx@gmail.com`)
    ...
    if (!siapa || !brp || isNaN(brp)) {
        reply("Format yang benar: .transfer 62895405449333 50000");
        return;
    }

    if (wanet === m.sender) {
        reply("Upss, mau nyoba transfer ke akun sendiri ya? Ehe tidak diperkenankan ya, Kak.");
        return;
    }
    ...
    if (!receiverData) {
        reply("Upss, Akun Itu Kayaknya Engga terdaftar di database kami pastiin bener yaa");
        return;
    }

    let senderBalance = cek("saldo", m.sender);
    if (brp > senderBalance) {
        reply(`Upss, Kamu belum bisa transfer ke ${siapa}! Karena Saldo kamu engga cukup isi dulu yukk`);
        return;
    }
    ...
    JamvanHax0r.sendMessage(wanet, { text: `Yuhuuu kamu telah menerima saldo dari pengguna ${dengan_nol}. Ref: ${refftf}/${formatmoney(brp)}` });
}
break;
/* Case Yang Tersedia */
...
case 'menu': {
    ...
    if (cek("verfiyemail", m.sender) === true) {
        ...
        return reply(`Silahkan lakukan pendaftaran terlebih dahulu dengan cara mengirim command beserta email Kakak sebagai berikut.\n\n*Example:* .setemail fionyalvshop@gmail.com`);
    }
     if (cek("cekVerify", m.sender) == true) return sendVerif()
    if(cek("syarat", m.sender) == true) return sendSyaratJHax0rr()
    ...
    const menuOptions = (m.sender === jhax0rr) ? sections : menuMember;
...
const buttonParamsJson = `{
    ...
    let msg = generateWAMessageFromContent(from, {
     ...
     JamvanHax0r.relayMessage(msg.key.remoteJid, msg.message, {
        messageId: msg.key.id
    }, { quoted: m });
    }, 2000);
}
...
case 'stalking': {
    if (cek("verfiyemail", m.sender) == true) return reply(`Silahkan lakukan pendaftaran terlebih dahulu dengan cara mengirim command beserta email Kakak sebagai berikut.\n\n*Example:* .setemail xxxxx@gmail.com`);
     if (cek("cekVerify", m.sender) == true) return sendVerif()
    if(cek("syarat", m.sender) == true) return sendSyaratJHax0rr()
    if (cek("level", m.sender) == "Jagoan Z") return reply(`Upss, Fitur Ini Khusus Untuk Akun Collector Z! Silahkan Upgrade akun anda`);
   if (cek("waktu", m.sender) == true) return JamBali()
...
case 'adminmenu': {
    ...
    if (cek("syarat", m.sender)) return sendSyaratJHax0rr();
...
break;
    ...
    await JamvanHax0r.relayMessage(allMemberMsg.key.remoteJid, allMemberMsg.message, {
...
case 'digiflazz': {
    ...
    await JamvanHax0r.relayMessage(digiflazzMsg.key.remoteJid, digiflazzMsg.message, {
...
const hi = `{
    ...
    await JamvanHax0r.relayMessage(intergrasiMsg.key.remoteJid, intergrasiMsg.message, {
...
𝗧𝗵𝗼𝘀𝗲 𝗮𝗿𝗲 𝗼𝘂𝗿 𝟭𝟬 𝗯𝗲𝘀𝘁 𝘀𝗲𝗹𝗹𝗶𝗻𝗴 𝗽𝗿𝗼𝗱𝘂𝗰𝘁𝘀`);
            ...
            reply("Upss, belum ada data produk terlaris.");
        }
    } catch (error) {
        console.error('Error reading/parsing the JSON file:', error);
        reply("Upss, terjadi kesalahan. Mohon hubungi admin untuk bantuan lebih lanjut.");
    }
    break;
}
...
case 'setemail': {
    ...
    if (cek("verfiyemail", m.sender) == false) 
        return reply(`Upss, Email hanya dapat diganti 1, jika ada kendala di email silahkan hubungi admin`);
    if (!cek("cekVerify", m.sender) == true) 
        return reply(`Upss, Silahkan periksa email : ${cek("email", m.sender)}, lalu ikuti langkah verifikasi`);
    ...
    if (!email.includes('@') || !isValidEmailFormat(email)) {
        return reply(`Upss, Email yang kamu input tidak valid`);
    }
    // Baca file JSON
    ...
    try {
        ...
        if (emailAlreadyExists) {
            return reply(`Upss, Email Telah Digunakan Oleh User Lain`);
        }
...
let code = "TPVerif_" + dengan_nol + "_" +generateRandomCodev(30);
    ...
    reply(`Sip, Kode verifikasi telah dikirim ke email : ${email}, jika tidak menemukan silahkan cek folder spam :)`);
        ...
        return reply("Upss, Terjadi kesalahan saat memperbarui email.");
    }
    break;
}
case 'verifikasicode':{
 if (cek("cekVerify", m.sender) == false) 
        return reply(`Upss, Kamu sudah terverifikasi`);
function generateRandomCodev(length) {
    let characters = 'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789';
    let code = '';
    for (let i = 0; i < length; i++) {
...
case 'registrasi': {
    ...
    if (userVerificationCode !== savedVerificationCode) {
        return reply("Upss, Verifikasi Code yang kamu input enggak valid :)");
    }
    ...
    // Kirim pesan ke jhax0rr dengan jumlah total pendaftar
    setTimeout(() => {
        JamvanHax0r.sendMessage(jhax0rr, { text: `*PENDAFTARAN USER BARU*\n\n> UserId : ${dengan_nol}\n> Email : ${userEmail}\n\nTotal pendaftar: ${totalMembers}`});
    }, 2400);
...
case 'minbalance': {
  ...
  setTimeout(function(){
  JamvanHax0r.sendMessage(id+ "@s.whatsapp.net",{text: `Yoo, Ada Update Saldo Terbaru dari admin!! Saldo Anda telah dikurangi sebesar ${formatmoney(saldo)} Saldo Akun Anda Sekarang ${formatmoney(updatedSaldo)}`})
  }, 3000)
...
case 'accdepo': {
    ...
    if (!fs.existsSync(filePath)) {
        return reply(`Upss, User ${id} tidak melakukan request deposit`);
    }
...
if (cek("cekVerify", m.sender) == true) return sendVerif()
    ...
    try {
        ...
        if (allUserData.length === 0) {
            return reply("Upss! belum ada data leaderboard");
        }
...
if(cek("level", m.sender) == "Jagoan Z") return reply(`Upss, Fitur Ini Khusus Untuk Akun Collector Z! Silahkan Upgrade akun anda`)
    ...
    try {
        ...
        if (allUserData.length === 0) {
          return reply("Upss! sepertinya belum ada data leaderboard ");
        }
...
case 'nonaktif.':{
    ...
    await JamvanHax0r.relayMessage(msg.key.remoteJid, msg.message, {messageId: msg.key.id}, { quoted: m });
}
break;
case 'nonaktif':{	
if (cek("cekVerify", m.sender) == true) return sendVerif()
...
break;
    ...
    await JamvanHax0r.relayMessage(leaderbordMsg.key.remoteJid, leaderbordMsg.message, {
...
case 'infotrxku':
    ...
    await JamvanHax0r.relayMessage(infotrxkuMsg.key.remoteJid, infotrxkuMsg.message, {
...
Apakah data pesanan kamu sudah benar?`;
    ...
    if (invoice) {
      if (cek("product_name", m.sender) == "") {
        return reply(`Upss, Kode *${customer_kode}* tidak ditemukan, coba cek lagi :)`);
      }
      sendMessage(invoice);
    }
  })
...
let axios = require('axios');
const url = `https://${global.APIcek}/api/au2m/?target=${customer_no}&api_key=${global.JHax0rCEK}`
axios.get(url)
  .then(response => {
  console.log(response.data);
...
if (cek("product_name", m.sender) == "") return reply(`Upss, Kode *${customer_kode}* tidak ditemukan, coba cek lagi :)`);
            sendMessage(invoice);
  })
  .catch(error => {
...
if(cek("verfiyemail", m.sender) == true) return reply(`Silahkan lakukan pendaftaran terlebih dahulu dengan cara mengirim command beserta email Kakak sebagai berikut.\n\n*Example:* .setemail xxxxx@gmail.com`)
    ...
    if (isImage || isVideo) {
        ...
        const encmedia = isImage ? await JamvanHax0r.sendImageAsSticker(m.chat, media, m, { packname, author: dengan_nol }) : await JamvanHax0r.sendVideoAsSticker(m.chat, media, m, { packname, author: dengan_nol });
        await fs.unlinkSync(encmedia);
    } else {
        JamvanHax0r.sendMessage(from, { text: `Reply Foto/Video Dengan Caption ${prefix + command}\n\nDurasi Video Max 1-9 Detik`}, { quoted: m });
    }
    break;
}
...
if(cek("verfiyemail", m.sender) == true) return reply(`Silahkan lakukan pendaftaran terlebih dahulu dengan cara mengirim command beserta email Kakak sebagai berikut.\n\n*Example:* .setemail xxxxx@gmail.com`)
    if (cek("status", m.sender) === true) {
        return reply(`Upss! Sepertinya kamu belum memiliki pesanan. Ayo, buat pesanan sekarang!`);
    } else {
        setTimeout(() => {
...
if(cek("verfiyemail", m.sender) == true) return reply(`Silahkan lakukan pendaftaran terlebih dahulu dengan cara mengirim command beserta email Kakak sebagai berikut.\n\n*Example:* .setemail fionyalvshop@gmail.com`)
  if(cek("level", m.sender) == "Jagoan Z") return reply(`Upss, Fitur Ini Khusus Untuk Akun Collector Z! Silahkan Upgrade akun anda`)
    if(cek("status", m.sender) == false) return JHax0rGalau()
...
*.bebasnominal DNA20|081236167286|20000*`);
  ...
  bankCode = 'link';
            ...
            if (bankCode) {
                const apiUrl = `https://${global.APIcek}/api/${bankCode}/?target=${no_wallet}&api_key=${global.JHax0rCEK}`;
...
const buttonParamsJson = `{
    ...
    reply("Upss, Nickname Tidak Dapat ditemukan")
    } else if ( error.response.data.code = "422") {
    reply("Upss, Silahkan Input Userid dengan benar")
    }
  });
  }
        })
        .catch(error => {
            if (error.response && error.response.data.data.message == "SKU tidak di temukan atau Non-Aktif") {
                setTimeout(() => {
                    JamvanHax0r.sendMessage(from, { text: `Gagal, periksa SKU KODE, pastikan sudah sesuai.` })
                }, 2000);
            }
        });
break;
case 'paybebasnominal': {
    ...
    if (cek("status", m.sender) == true) return reply(`Upss, Kamu tidak memiliki status pesanan :)`)
    ...
    axios(config)
        .then(async res => {
            ...
            if (res.data.data.status == "Gagal") {
                JamvanHax0r.sendMessage(`${owner}@s.whatsapp.net`, {
                    text: `Gagal, ${res.data.data.message}`
                });
                JamvanHax0r.sendMessage(`${owner}@s.whatsapp.net`, { text: `*KESALAHAN SISTEM*
...
Oke Sip, pesanan kamu udah berhasil! Makasih udah belanja di *${footer}*`;
                    ...
                    JamvanHax0r.relayMessage(cek("id", m.sender), msg.message, {
                        messageId: msg.key.id
                    }, { quoted: m });
...
> Tanggal Penjualan : ${moment.tz(`Asia/${waktuzone}`).format('HH:mm:ss')} | ${moment.tz('Asia/Jakarta').format('DD/MM/YY')}`
                    }, { quoted: m });
        ...
        .catch(error => {
            if (error.response) {
                sett("+saldo", `${ru}@s.whatsapp.net`, total_wallet);
                JamvanHax0r.sendMessage(`${ru}@s.whatsapp.net`, {
...
if (i.price > cek("saldo", m.sender)) return MinesJHax0rr()
...
axios(config)
.then(async res => {
JamvanHax0r.sendMessage(cek("id", m.sender), {text:`*RINCIAN PEMESANAN*
...
let pesany = response.data.data.message
    let GagalTr = JSON.parse(fs.readFileSync(trxFilePath, 'utf8'));
        const NewGagal = {
            ...
            harga_modal: "0",
            tujuan: user_no,
            invoice: "Upss, Transaksi ini sudah dibatalkan oleh sistem",
        };
...
> Tanggal Penjualan : ${moment.tz(`Asia/${waktuzone}`).format('HH:mm:ss')} | ${moment.tz(`Asia/${waktuzone}`).format('DD/MM/YY')}`
     ...
     JamvanHax0r.relayMessage(jhax0rr, msg.message, {
        messageId: msg.key.id
    }, { quoted: m });
    }, 2000);
   const trxFilePath = './SETTING/DB/dataTrx.json';
...
if (cek("cekVerify", m.sender) == true) return sendVerif()
    if(cek("syarat", m.sender) == true) return sendSyaratJHax0rr()
    if (cek("status", m.sender) == true) return reply(`Upss, kamu belum memiliki invoice! buat dulu yukk`);
    if(fs.existsSync(`./SETTING/DB/TRANSACTION/Api/Deposit/${cek("deposit", m.sender)}.json`)) return JHax0rGalauV() 
...
fs.writeFileSync(`./SETTING/DB/TRANSACTION/Api/Deposit/${cek("deposit", m.sender)}.json`, JSON.stringify(obj))
 ...
 hasMediaAttachment: true,...(await prepareWAMessageMedia({ image: { url: `${paymentDataResponse.qrcode_url}` } }, { upload: JamvanHax0r.waUploadToServer }))
 }),
                nativeFlowMessage: proto.Message.InteractiveMessage.NativeFlowMessage.create({
                    buttons: [
                        {
...
switch(response.data.data.rc) {
    case "60":
        reply("Upss, tagihan untuk bulan ini nggak ada nih! Coba lagi bulan depan ya :)")
        break;
    case "43":
        reply("Upss, *Kode SKU* tidak ada! pastikan sudah sesuai database kami ya :)")
        break;
    case "02":
        JamvanHax0r.sendMessage(from, { text: "Upss, Terjadi kendala di sistem! Coba lagi nanti :)" });
        break;
    case "54":
        JamvanHax0r.sendMessage(from, { text: "Upss, ID pelanggan kamu tidak terdaftar di penyedia layanan! Pastikan udah benar ya :)" });
        break;
}
        })
        .catch(error => {
    if (error.response) {
      ...
      reply("Upss, Gagal dari sistem! silahkan hubungi cs :)")
      
setTimeout(() => {
      JamvanHax0r.sendMessage(jhax0rr, { text: `Upss, ${error.response.data.data.message}`}, { Quoted: m })
      }, 1000);
                }
        });
}
...
if(total_tagihan > cek("saldo", m.sender)) return reply(`Upss, Saldo tidak cukup! Isi dulu yuk :)`)
...
await loading();
   if (response.data.data.status == "Gagal") 
              {           
              sett("+saldo", ru+"@s.whatsapp.net", total_tagihan) 
 JamvanHax0r.sendMessage(from, { text : `Upss, ${response.data.data.message}`})
 JamvanHax0r.sendMessage(`${owner}@s.whatsapp.net`, {text:`🚨 *LAPORAN KESALAHAN TIDAK BERHASIL:*
    ...
    .catch(error => {
      if (error.response) {
            console.log(error.response.data.data)
                sett("+saldo", ru + "@s.whatsapp.net", total_tagihan);
                reply("Upss, Gagal dari sistem! silahkan hubungi cs :)")
                JamvanHax0r.sendMessage(`${owner}@s.whatsapp.net`, { text: `Upss, ${String(error.response.data.data.message)}` });
                setTimeout(() => {
                    sett("price", m.sender, 0);
                    sett("product_name", m.sender, "");
                    sett("status", m.sender, true);
...
if (cek("cekVerify", m.sender) == true) return sendVerif()
    ...
    if (from) {
        ...
        await JamvanHax0r.relayMessage(prabayarMsg.key.remoteJid, prabayarMsg.message, {
...
`;
    ...
    JamvanHax0r.relayMessage(m.chat,  {
...
if (cek("cekVerify", m.sender) == true) return sendVerif()
    ...
    if (brands.length > 0) {
        ...
        await JamvanHax0r.relayMessage(pascabayarMsg.key.remoteJid, pascabayarMsg.message, {
...
break;
 case 'list': {
    ...
    if (types.length > 0) {
        ...
        await JamvanHax0r.relayMessage(smmMsg.key.remoteJid, smmMsg.message, {
...
if (cek("cekVerify", m.sender) == true) return sendVerif()
    ...
    if (!requestedDesc) return m.reply("Upss, kamu belum input deskripsi produk.");
...
if (cek("cekVerify", m.sender) == true) return sendVerif()
    ...
    // Memeriksa apakah pengguna menyertakan merek customer_kode
    if (!requestedBrand) return m.reply("Upss, kamu belum input brand.");
...
case 'manual': {
    ...
    if (isNaN(depositAmount)) {
        return reply(`Upss, Cara Deposit Salah\n\nContoh : .manual 20000`);
    }
    ...
    if (depositAmount < 10000) {
        return m.reply(`Upss, minimal deposit 10.000`);
    }
    if (depositAmount > 2000000) {
        return m.reply(`Upss, maximal deposit 2 juta`);
    }
...
> OVO : 0895405449333
> SHOPEEPAY : 0895405449333
> LINKAJA : 0895405449333
> DANA : 0895405449333

  *TRANSFER BANK*
> BANK DKI : 31823048567
> BANK JAGO : 107093200630
...
! Jika Saldo Belum Masuk Sampai 1 Jam Silahkan Hubungi Admin
    ...
    let qtt = { url: 'https://telegra.ph/file/0868e97ca554197ff6fae.jpg' };
    JamvanHax0r.sendMessage(from, { image: qtt, caption: depositInfoMessage }, { quoted: m });
...
if (cek("verfiyemail", m.sender) == true) return reply(`Silahkan lakukan pendaftaran terlebih dahulu dengan cara mengirim command beserta email Kakak sebagai berikut.\n\n*Example:* .setemail xxxxx@gmail.com`);
    ...
    if(cek("syarat", m.sender) == true) return sendSyaratJHax0rr()
    if (!fs.existsSync(`./SETTING/DB/TRANSACTION/Api/Deposit/${cek("deposit", m.sender)}.json`)) {
        JamvanHax0r.sendMessage(from, { text: "Upss! Sepertinya belum ada Invoice yang tersedia saat ini.." }, { quoted: m });
    } else {
...
let total = `${request_depo}` * 1
      if (isNaN(request_depo)) {
        reply("Upss, deposit harus berupa angka bukan simbol/selain angka");
        return;
    }
if (!request_depo) return reply(`Upss, format salah, ikuti yang bener yuk :\n\nContoh: ${prefix + command} 5000`)
if (total < minimal) return m.reply(`Upss, minimal deposit adalah ${formatmoney(minimal)}`)
if (total > max) return m.reply(`Upss, Maximal deposit adalah ${formatmoney(max)}`)
  async function makePayment() {
    try {
      let keynya = global.PayDisiniKey;
      let kodeunick = koderefe
...
if (!request_depo) return reply(`Upss, Parameter salah! Silahkan Ikuti\n\n> Contoh : ${prefix + command} 5000`)
if (total < minimal) return m.reply(`Upss, minimal deposit adalah ${formatmoney(minimal)}`)
if (total > max) return m.reply(`Upss, Maximal deposit adalah ${formatmoney(max)}`)
  async function makePayment() {
    try {
...
case 'wdtokopay': {
    ...
    if (!wdnominal) return m.reply(`Upss, Format Withdraw salah :\n\n> Contoh : .tarik- 100000`);
...
case 'tourl': {
        ...
        let media = await JamvanHax0r.downloadAndSaveMediaMessage(qmsg)
        if (/image/.test(mime)) {
    ...
    /* LIST XL AXIATA*/
 case 'd-xl': {
 if (cek("verfiyemail", m.sender)) return reply(`Silahkan lakukan pendaftaran terlebih dahulu dengan cara mengirim command beserta email Kakak sebagai berikut.\n\n*Example:* .setemail xxxxx@gmail.com`);
        if (cek("cekVerify", m.sender)) return sendVerif();
        if (cek("syarat", m.sender)) return sendSyaratJHax0rr();
    ...
    await JamvanHax0r.relayMessage(interactiveMessage.key.remoteJid, interactiveMessage.message, {
...
if (cek("verfiyemail", m.sender) == true) return reply(`Silahkan lakukan pendaftaran terlebih dahulu dengan cara mengirim command beserta email Kakak sebagai berikut.\n\n*Example:* .setemail xxxxx@gmail.com`);
    ...
    if(cek("syarat", m.sender) == true) return sendSyaratJHax0rr()
            ...
            let name = await JamvanHax0r.updateProfileStatus(text)
            ...
            break
                 ...
                 JamvanHax0r.sendTextWithMentions(m.chat, teks, m)
             }
             break
             case 'listgc': {
                 ...
                 for (let i of anu) {
                     let metadata = await JamvanHax0r.groupMetadata(i)
             ...
             case 'listonline': case 'liston': {
                    ...
                    JamvanHax0r.sendText(m.chat, 'List Online:\n\n' + online.map(v => '⭔ @' + v.replace(/@.+/, '')).join`\n`, m, { mentions: online })
             }
             break
	    ...
	    localFile = await JamvanHax0r.downloadAndSaveMediaMessage(qmsg, hmm)
	    ...
	    JamvanHax0r.sendMessage(m.chat, {image: fs.readFileSync(outputFile), caption: mess.success}, { quoted : m })
        ...
        if (dataStatus === "Success") {
          const deppo = JSON.parse(fs.readFileSync(`./SETTING/DB/TRANSACTION/Api/Deposit/${cek("deposit", m.sender)}.json`))
              ...
              let member = `${checkIdDepo(m.sender, deppo) ? checkIdDepo(m.sender, deppo) : deppo.id}`
               ...
               let total_sender = `${checkIdDepo(m.sender, deppo) ? checkIdDepo(m.sender, deppo) : deppo.total}` * 1
               sendEmailDepo(sender, pushname, ref_sender, method, price_sender, fee_sender, total_sender);
             JamvanHax0r.sendMessage(nomor+"@s.whatsapp.net", { text : "Terimakasih Telah melakukan pembelian scprit bot WhatsApp :), Scprit akan dikirimkan ~"})
...
break;
 ...
 let msg = generateWAMessageFromContent(m.chat, {
  ...
  if (!akun) return reply("Upss, perintah salah\n\n> Contoh : .delakun 62851xxxx")
    ...
    if (index !== -1) {
        ...
        // Tambahkan pesan respons langsung
        reply("Upss, akun tidak ditemukan");
    }
    }
    break;
  case 'hapusakun':
...
const url = `https://${global.APIcek}/api/life-after/?target=${id}&zone=${zone}&api_key=${global.JHax0rCEK}`
...
const { createCanvas, loadImage } = require('canvas');
    ...
    if (!refId) {
        reply("Upss, Silahkan Masukkan ReffId Pesanan Sukses\n\n*Contoh : print TPxxxxx*");
        return;
    }
    ...
    try {
        ...
        if (!userData) {
            return reply(`Upss, pesanan ${refId} tidak ditemukan :(`);
        }
        ...
        createReceipt(userData, function(err) {
            if (err) {
                ...
                reply("Upss, silahkan hubungi admin");
            } else {
...
function createReceipt(userData, callback) {
    ...
    context.fillText('Fiony-Shop', width / 2, 120); // Posisi disesuaikan
...
const fs = require('fs');
    ...
    JamvanHax0r.sendMessage(from, { image: image }, { quoted: m });
...
const axios = require('axios');
    ...
    try {
        ...
        if (!userData) {
            return reply(`Upss, tidak dapat melakukan print silahkan cek refid pembelian`);
        }
...
const response = await axios.get(apiUrl, { responseType: 'stream' });
                ...
                if (response.status === 200) {
                    ...
                    // Pastikan variabel 'from' dan 'm' didefinisikan sebelumnya
                     JamvanHax0r.sendMessage(from, receipt, { quoted: m });
...
case 'upscale': case 'hdr': {
  ...
  try {
    let ahah = await JamvanHax0r.downloadAndSaveMediaMessage(quoted, `./SETTING/DB/${m.sender.split('@')[0]}.jpg`);
    ...
    JamvanHax0r.sendMessage(from, { image: get_result, caption: `*Done converter HD*` }, { quoted: m });
    fs.unlinkSync(ahah);
  } catch (err) {
    console.log(err);
...
case 'ai':
    ...
    let jhax0rNick = text.split(" ")[0];
        if (!jhax0rNick) return reply("Mohon masukkan API key Nick yang valid, contoh: .setapizann zannkey-NxpMXoIo93-d3ECg");
    const axios = require("axios");
    var config = {
        method: 'POST',
        url: 'https://zannstoresmm.my.id/api/config.php',
    ...
    axios(config)
        .then(function (response) {
            if (response.data.status == true) {
             ...
             sett("APInick", m.sender, jhax0rNick)
...
break;
    ...
    .then(response => {
        ...
        // Save the settings
        sett("merchant_id", jhax0rr, mrcht);
        sett("secret_key", jhax0rr, scrt);
        sett("tokopay", jhax0rr, false);
        sett("allapi", jhax0rr, false);
    })
    .catch(error => {
    ...
    axios(config)
        .then(response => {
            if (response.data.data) {
                ...
                reply("Upss, APIkey Tidak ditemukan atau salah");
            }
        })
        .catch(error => {
            console.error("Error:", error);
    ...
    (async () => {
        try {
            ...
            if (response.data.data) {
                ...
                reply("Upss, API key Tidak ditemukan atau salah");
            }
        } catch (error) {
            console.error("Error:", error);
            reply("Upss, API key Tidak ditemukan atau salah");
...
await jadibot(JamvanHax0r, text, fkontak, from)
            let loli = '`'
     await sleep(4500)      
...
let axios = require('axios');
  ...
  async function createImage(url) {
    const { imageMessage } = await generateWAMessageContent({
      ...
      upload: JamvanHax0r.waUploadToServer
    });
    return imageMessage;
  }
  ...
  await JamvanHax0r.relayMessage(m.chat, bot.message, { messageId: bot.key.id });
}
break;
case 'customgame': {
...
case 'getsmm': {
    ...
    let hi = q.split(" ")[0]
    if (!hi) return reply("Upss format salah\nContoh : .getsmm 1.1\n 1.1 = 10%\n1.2 = 20%")
    const crypto = require("crypto");
    const axios = require("axios");
    const md5 = require('md5');
    ...
    const Api_Key = global.JHax0rCEK
...
case 'smm': {
    if (cek("verifyemail", m.sender) == true) return reply(`Silahkan lakukan pendaftaran terlebih dahulu dengan cara mengirim command beserta email Kakak sebagai berikut.\n\n*Example:* .setemail xxxxx@gmail.com`);
    if (cek("cekVerify", m.sender) == true) return sendVerif();
    if (cek("syarat", m.sender) == true) return sendSyaratJHax0rr();
...
case 'ordersmm': {
    ...
    if (!smmFound) {
        return reply(`Upss, Kode *${code_smm}* tidak ditemukan, coba cek lagi :)`);
    }
...
case 'lanjutsmm': {
    const APIKEY = global.JHax0rCEK
    if (cek("smm_status", m.sender)) return reply(`Upss, Kamu tidak memiliki status pesanan :)`);
    const axios = require('axios');
    let code_smm = cek("smm_code", m.sender);

    for (let smm of zannSmm) {
        if (smm.id == code_smm) {
         let jhax0rZ = cek("smm_harga", m.sender) * 1;
            if (jhax0rZ > cek("saldo", m.sender)) return reply("Upss, Saldo tidak cukup");
...
JamvanHax0r.sendMessage("6285183591882@s.whatsapp.net", { text: errorMessage });
    }
}
